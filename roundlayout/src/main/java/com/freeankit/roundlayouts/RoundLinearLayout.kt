 ...
 */
class RoundLinearLayout@JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
        LinearLayout(context, attrs, defStyleAttr) {
    private val canvasRounder: CanvasRounder

    init {
        val array = context.obtainStyledAttributes(attrs, R.styleable.RoundLinearLayout, 0, 0)
        val cornerRadius = array.getDimension(R.styleable.RoundLinearLayout_corner_radius, 0f)
        array.recycle()
